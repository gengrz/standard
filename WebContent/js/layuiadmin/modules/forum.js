...
function(e) {
    ...
    i.on("tool(LAY-app-forum-list)",
    function(e) {
        e.data;
        if ("del" === e.event) layer.confirm("确定删除此条帖子？",
        function(t) {
            e.del(),
            layer.close(t)
        });
    ...
    i.on("tool(LAY-app-forumreply-list)",
    function(e) {
        e.data;
        if ("del" === e.event) layer.confirm("确定删除此条评论？",
        function(t) {
            e.del(),
            layer.close(t)
        });
