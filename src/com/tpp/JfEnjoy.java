...
public class JfEnjoy {
	...
	public boolean render(String templateFileName, Kv kv, String  filePath) {
		...
		try {
			String baseTemplatePath = new StringBuilder(PathKit.getRootClassPath()).append("/")
			...
			Engine.use().setBaseTemplatePath(baseTemplatePath)
					// .setSourceFactory(new ClassPathSourceFactory())
					.getTemplate(templateFileName).render(kv, output);
